...
const DECISIONING_PAYLOAD = {
  version: "1.0.0",
  meta: {
    generatedAt: "2020-02-28T19:43:44.476Z"
  },
  rules: [
    {
      condition: {
            ...
            metrics: [
              {
                type: "display",
                eventToken:
                  "wQY/V1IOYec8T4fAT5ww7greqXMfVUcUx0s/BHR5kCKCnQ9Y9OaLL2gsdrWQTvE54PwSz67rmXWmSnkXpSSS2Q=="
              }
            ],
            name: "daterange-mbox"
          }
