            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        _i++;
                        return [3, 1];
                    case 4: return [4, this.configuration.fetchApi(fetchParams.url, fetchParams.init)];
                    case 5:
                        response = _d.sent();
        ...
        get: function () {
            ...
            return function (input, init) {
                return new Promise(function (resolve, reject) {
                    ...
                    fetch(input, init).then(function (response) { return resolve(response); }, function (err) { return reject(err); }).finally(function () { return clearTimeout(timer); });
                });
            };
        },
        enumerable: true,
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _b = {};
                        return [3, 3];
                    case 1: return [4, this.raw.json()];
                    case 2:
                        _b = _c.sent();
                        _c.label = 3;
                    case 3: return [2, _a.apply(this, [_b])];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2, new JSONApiResponse(response, function (jsonValue) { return DeliveryResponseFromJSON(jsonValue); })];
                }
            });
        });
    };
    DeliveryAPIApi.prototype.execute = function (client, sessionId, deliveryRequest, version) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.executeRaw({ client: client, sessionId: sessionId, deliveryRequest: deliveryRequest, version: version })];
                    case 1:
                        response = _a.sent();
